...
app.get("/info", (req, res) => {
    res.json({
        ...
        "Main motto": "To get the job by entering your skills and related analysis",
        "Process": "To get started with this:- 1) The user will be posting its resume , 2) Resume gets parsed here . 3) Then the details of resume text are sent to the backend for AI skills filtering. 4) "
    });
});
