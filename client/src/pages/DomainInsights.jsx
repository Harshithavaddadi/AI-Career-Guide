...
const DomainInsights = () => {
  ...
  if (domains.length === 0)
    return (
      <div className="pt-6 px-6 bg-amber-950 rounded-lg border border-amber-700">
  ...
  return (
    <div className="space-y-8 pb-8 pt-12">
      {/* Header */}
      <div className="bg-gradient-to-r from-violet-600 to-cyan-500 text-white p-6 rounded-lg">
